...
public abstract class EnumerableStatePolicy extends Policy {
	...
	protected EnumerableStatePolicy(List<String> stateVariableNames, int remainingHorizons ,
		...
		this.remainingHorizons = remainingHorizons;
		this.discountFactor = discountFactor;
		this.actions = actions;
		this.rddlInstance = instance;
		this.translation = translation;
		this._random = rand;
		this._rddl = rddl;
		this._sInstanceName = instance_name;
	}
	...
	protected List<CString> getLegalActions(Map<String,ArrayList<PVAR_INST_DEF>> actions_map) {
		ArrayList<CString> legal_actions = new ArrayList<>();
		for(String key : actions_map.keySet()){
			legal_actions.add(new CString(key));
		}
